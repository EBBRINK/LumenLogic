...
-- • Memberships voor de bestaande gebruikers: alle drie de user-rijen zijn Brink-kant
--   (Timo tweemaal, Eduard eenmaal), dus alle drie org_admin in de interne org. Op een
--   verse test-DB is `user` leeg en raakt deze INSERT nul rijen.
...
ALTER TABLE organizations ADD COLUMN type org_type NOT NULL DEFAULT 'extern';
--> statement-breakpoint
