...
export const FIELD_CATALOG: CatalogBucket[] = [
  {
    ...
    fields: [
      ...
      { key: "name_en", labelNl: "Productnaam (EN)", labelEn: "Product name (English)", niveau: "must", ...extern, instructie: "Engelse productnaam, bv. 'Downlight Vega 15W 3000K'.", instructionEn: "English product name, e.g. 'Downlight Vega 15W 3000K'.", measure: col("name") },
      { key: "description_en", labelNl: "Omschrijving (EN)", labelEn: "Description (English)", niveau: "wanna", ...extern, instructie: "Korte Engelse omschrijving, 1–3 zinnen.", instructionEn: "Short English description, 1–3 sentences.", measure: col("description") },
