...
export const FIELD_CATALOG: CatalogBucket[] = [
  ...
  },
  {
    ...
    order: 3,
    fields: [
      { key: "height_cm", labelNl: "Hoogte (cm)", labelEn: "Height (cm)", niveau: "wanna", ...extern, matcher: true, instructie: "Hoogte in centimeters, bv. 12,5.", instructionEn: "Height in centimetres, e.g. 12.5.", measure: col("height_cm") },
      { key: "width_cm", labelNl: "Breedte (cm)", labelEn: "Width (cm)", niveau: "wanna", ...extern, matcher: true, instructie: "Breedte in centimeters, bv. 20.", instructionEn: "Width in centimetres, e.g. 20.", measure: col("width_cm") },
      { key: "length_cm", labelNl: "Lengte (cm)", labelEn: "Length (cm)", niveau: "wanna", ...extern, matcher: true, instructie: "Lengte in centimeters, bv. 120.", instructionEn: "Length in centimetres, e.g. 120.", measure: col("length_cm") },
      { key: "diameter_cm", labelNl: "Diameter (cm)", labelEn: "Diameter (cm)", niveau: "wanna", ...extern, matcher: true, instructie: "Diameter in centimeters, bv. 8,5.", instructionEn: "Diameter in centimetres, e.g. 8.5.", measure: col("diameter_cm") },
      { key: "cutting_size_height_cm", labelNl: "Zaagmaat hoogte (cm)", labelEn: "Cut-out height (cm)", niveau: "nice", ...extern, instructie: "Inbouw-zaagmaat hoogte in centimeters.", instructionEn: "Recessed cut-out height in centimetres.", measure: NONE },
      { key: "cutting_size_width_cm", labelNl: "Zaagmaat breedte (cm)", labelEn: "Cut-out width (cm)", niveau: "nice", ...extern, instructie: "Inbouw-zaagmaat breedte in centimeters.", instructionEn: "Recessed cut-out width in centimetres.", measure: NONE },
      { key: "cutting_size_length_cm", labelNl: "Zaagmaat lengte (cm)", labelEn: "Cut-out length (cm)", niveau: "nice", ...extern, instructie: "Inbouw-zaagmaat lengte in centimeters.", instructionEn: "Recessed cut-out length in centimetres.", measure: NONE },
      { key: "cutting_size_diameter_cm", labelNl: "Zaagmaat diameter (cm)", labelEn: "Cut-out diameter (cm)", niveau: "nice", ...extern, instructie: "Inbouw-zaagmaat diameter in centimeters, bv. 6,8.", instructionEn: "Recessed cut-out diameter in centimetres, e.g. 6.8.", measure: NONE },
    ],
  },
  {
    key: "uiterlijk",
    ...
    order: 4,
    fields: [
      { key: "color_1", labelNl: "Kleur (primair)", labelEn: "Colour (primary)", niveau: "wanna", ...extern, matcher: true, instructie: "Hoofdkleur, bv. 'wit' of 'RAL 9005'.", instructionEn: "Main colour, e.g. 'white' or 'RAL 9005'.", measure: col("color_1") },
      { key: "material_1", labelNl: "Materiaal (primair)", labelEn: "Material (primary)", niveau: "wanna", ...extern, matcher: true, instructie: "Hoofdmateriaal, bv. 'aluminium'.", instructionEn: "Main material, e.g. 'aluminium'.", measure: col("material_1") },
      { key: "color_2", labelNl: "Kleur (secundair)", labelEn: "Colour (secondary)", niveau: "nice", ...extern, instructie: "Tweede kleur, indien van toepassing.", instructionEn: "Secondary colour, if applicable.", measure: NONE },
      { key: "material_2", labelNl: "Materiaal (secundair)", labelEn: "Material (secondary)", niveau: "nice", ...extern, instructie: "Tweede materiaal, indien van toepassing.", instructionEn: "Secondary material, if applicable.", measure: NONE },
    ],
  },
  {
    key: "lichtbron_fitting",
    labelNl: "Lichtbron & fitting",
    labelEn: "Light source & socket",
    order: 5,
    fields: [
      ...
      { key: "lamp_foot", labelNl: "Fitting", labelEn: "Lamp base", niveau: "wanna", ...extern, instructie: "Lampvoet, bv. E27, GU10, G9.", instructionEn: "Lamp base, e.g. E27, GU10, G9.", measure: NONE },
  ...
  },
  {
    ...
    order: 6,
    fields: [
      { key: "kelvin", labelNl: "Kleurtemperatuur (K)", labelEn: "Colour temperature (K)", niveau: "wanna", ...extern, matcher: true, instructie: "Kleurtemperatuur in kelvin, bv. 3000.", instructionEn: "Colour temperature in kelvin, e.g. 3000.", measure: col("kelvin") },
      { key: "lumen_output", labelNl: "Lichtstroom (lm)", labelEn: "Luminous flux (lm)", niveau: "wanna", ...extern, matcher: true, instructie: "Lichtstroom in lumen, bv. 1100.", instructionEn: "Luminous flux in lumens, e.g. 1100.", measure: col("lumen_output") },
      { key: "cri", labelNl: "CRI", labelEn: "CRI", niveau: "wanna", ...extern, matcher: true, instructie: "Kleurweergave-index, bv. 90.", instructionEn: "Colour rendering index, e.g. 90.", measure: col("cri") },
      ...
      { key: "sdcm", labelNl: "SDCM", labelEn: "SDCM", niveau: "wanna", ...extern, instructie: "Kleurconsistentie in SDCM/MacAdam, bv. 3.", instructionEn: "Colour consistency in SDCM/MacAdam steps, e.g. 3.", measure: NONE },
  ...
  },
  {
    ...
    order: 8,
    fields: [
      { key: "ip_value", labelNl: "IP-waarde", labelEn: "IP rating", niveau: "wanna", ...extern, matcher: true, instructie: "Beschermingsgraad, bv. IP44 of IP65.", instructionEn: "Ingress protection rating, e.g. IP44 or IP65.", measure: col("ip_value") },
