...
// De kaart los van de lijst: de verwijder-selectie (dossier-list-selectable.tsx) zet er
// een checkbox NAAST — buiten deze anchor, want een checkbox ín een <a> nest interactieve
// elementen en dan wint de navigatie de klik.
export function DossierCard({ d }: { d: DossierListItem }) {
  return (
    <a
      href={`/projects/${d.id}`}
