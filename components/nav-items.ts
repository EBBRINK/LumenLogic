...
// "Brand relations" (/data/brand-relations) = intern merkenbeheer, waar Brink werkt — een
// hoofdingang, dus ná Catalog en vóór Data. "Brand portal" (/brand) = wat een mérk ziet.
// Label volgt docs/i18n-glossary-xis.md (besluit Timo 20 jul; de briefing zei "Brands").
export const NAV_ITEMS: readonly NavItem[] = [
  { href: "/projects", label: "Projects" },
  { href: "/catalog", label: "Catalog" },
  { href: "/data/brand-relations", label: "Brand relations" },
...
// /data/brand-relations, en alleen de langste (Brand relations) mag oplichten. Daarom
// wordt dit één keer centraal beslist en niet per link.
